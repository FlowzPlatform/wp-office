...
<!-- Appearance Setting Box Starts -->
	<div id="wmpci-appearance-features" class="post-box-container wmpci-appearance-features">
		<div class="metabox-holder">
			<div class="meta-box-sortables ui-sortable">
				<div id="appearance" class="postbox">
					...
					<button class="handlediv button-link" type="button"><span class="toggle-indicator"></span></button>
						...
						<!-- Settings box title -->
						<h3 class="hndle">
							<span><?php _e( 'Upgrade to PRO VERSION', 'wp-modal-popup-with-cookie-integration' ); ?></span>
						</h3>
						
						<div class="inside">
						
						<table class="form-table wmpci-appearance-features-tbl">
							<tbody>									
								<tr>
									<td colspan="2" valign="top" scope="row">
										<ul>
											<li>1) Create Unlimited Popups</li>
											<li>2) Welcome popup on page load</li>
											<li>3) Exit Intent!</li>
											<li>4) Open when user scrolled XX% page!</li>
											<li>5) Open after X sec of inactivity (no mouse or keyboards actions)!</li>
											<li>6) 8 Popup position</li>
											<li>7) Insert your pop-up into any page or a post</li>
											<li>8) 10 predefined layouts</li>
											<li>9) Add any Video, HTML, iFrame, Shortcode of any plugin to display on popup.</li>
											<li>10) Display Popup on load page</li>
											<li>11) Display Popup on close/leave page</li>
											<li>12) Page level Targeting (different popups for each post/page, turn popup on/off for all page or for few pages/posts)</li>
											<li>13) Close button (show button: yes/no, auto close popup)</li>
											<li>14) Open Delay (open popup delay in seconds)</li>
											<li>15) Customize the look and feel of the popup</li>
											<li>16) Change popup content background color</li>
											<li>17) Customize popup overlay color and opacity</li>
											<li><p>View <a href="http://wponlinesupport.com/wp-plugin/wp-modal-popup-cookie-integration/" rel="nofollow">PRO DEMO</a> for more details.</p>
											</li>
										</ul>
									</td>
								</tr>
