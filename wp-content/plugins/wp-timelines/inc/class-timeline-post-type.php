...
class WPEX_TL_Posttype {
	...
	function register_metadata(array $meta_boxes){
		...
		$speaker_settings = array(	
				...
				array( 'id' => 'wpex_icon', 'name' => esc_html__('Icon', 'wp-timeline'), 'default'=> '', 'type' => 'text','desc' => esc_html__('Enter Font Awesome icon class (Ex: fa-star) (Only used for Timeline Listing shortcode)', 'wp-timeline') , 'repeatable' => false, 'multiple' => false, 'cols' => 6 ),
