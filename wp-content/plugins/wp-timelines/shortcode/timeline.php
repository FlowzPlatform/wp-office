...
function parse_wpex_timeline_func($atts, $content){
	global $style,$ajax_load,$ID,$animations, $posttype,$show_media, $taxonomy,$full_content,$feature_label,$lightbox,$hide_img;
	$ajax_load = 0;
	...
	if($style=='bg'){ $css_class .= ' show-icon';}
	if($style=='clean'){ $css_class .= ' show-simple';}
	...
	vc_map( array(
	   ...
	   "params" => array(
		  ...
		  array(
			 ...
			 "type" => "dropdown",
			 "class" => "",
			 "heading" => esc_html__("Enable infinite Scroll", "wp-timeline"),
			 "param_name" => "infinite",
			 "value" => array(
			 	esc_html__('No', 'wp-timeline') => '',
			 	esc_html__('Yes', 'wp-timeline') => '1',
