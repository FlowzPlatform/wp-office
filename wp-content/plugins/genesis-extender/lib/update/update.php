...
function genesis_extender_update()
{
	...
	if( version_compare( get_option( 'genesis_extender_version_number' ), '1.2', '<' ) )
	{
		...
		$genesis_extender_hook_boxes = !get_option( 'genesis_extender_custom_hook_boxes' ) ? array() : get_option( 'genesis_extender_custom_hook_boxes' );
	...
	// Update to Genesis Extender 1.6
	if( version_compare( get_option( 'genesis_extender_version_number' ), '1.6', '<' ) )
	{	
		update_option( 'genesis_extender_version_number', '1.6' );
	}

	// Update to Genesis Extender 1.6.1
	if( version_compare( get_option( 'genesis_extender_version_number' ), '1.6.1', '<' ) )
	{	
		update_option( 'genesis_extender_version_number', '1.6.1' );
	}

	// Update to Genesis Extender 1.6.2
	if( version_compare( get_option( 'genesis_extender_version_number' ), '1.6.2', '<' ) )
	{	
		update_option( 'genesis_extender_version_number', '1.6.2' );
	}

	// Update to Genesis Extender 1.6.3
	if( version_compare( get_option( 'genesis_extender_version_number' ), '1.6.3', '<' ) )
	{	
		update_option( 'genesis_extender_version_number', '1.6.3' );
	}

	// Update to Genesis Extender 1.6.4
	if( version_compare( get_option( 'genesis_extender_version_number' ), '1.6.4', '<' ) )
	{	
		update_option( 'genesis_extender_version_number', '1.6.4' );
	}

	// Update to Genesis Extender 1.6.5
	if( version_compare( get_option( 'genesis_extender_version_number' ), '1.6.5', '<' ) )
	{	
		update_option( 'genesis_extender_version_number', '1.6.5' );
	}
	
	// Update to Genesis Extender 1.6.6
	if( version_compare( get_option( 'genesis_extender_version_number' ), '1.6.6', '<' ) )
	{	
		update_option( 'genesis_extender_version_number', '1.6.6' );
	}
	
	// Update to Genesis Extender 1.7.0
	if( version_compare( get_option( 'genesis_extender_version_number' ), '1.7.0', '<' ) )
	{	
		update_option( 'genesis_extender_version_number', '1.7.0' );
	}
	
	// Update to Genesis Extender 1.7.1
	if( version_compare( get_option( 'genesis_extender_version_number' ), '1.7.1', '<' ) )
	{	
		update_option( 'genesis_extender_version_number', '1.7.1' );
	}
	
	// Update to Genesis Extender 1.7.2
	if( version_compare( get_option( 'genesis_extender_version_number' ), '1.7.2', '<' ) )
	{	
		update_option( 'genesis_extender_version_number', '1.7.2' );
	}
	
	// Update to Genesis Extender 1.7.3
	if( version_compare( get_option( 'genesis_extender_version_number' ), '1.7.3', '<' ) )
	{
		$genesis_extender_settings = get_option( 'genesis_extender_settings' );
		$new_genesis_extender_settings = array(
		...
		update_option( 'genesis_extender_version_number', '1.7.3' );
	}
	
	// Update to Genesis Extender 1.7.4
	if( version_compare( get_option( 'genesis_extender_version_number' ), '1.7.4', '<' ) )
	{	
		update_option( 'genesis_extender_version_number', '1.7.4' );
	}
	
	// Update to Genesis Extender 1.7.5
	if( version_compare( get_option( 'genesis_extender_version_number' ), '1.7.5', '<' ) )
	{	
		update_option( 'genesis_extender_version_number', '1.7.5' );
	}
	
	// Update to Genesis Extender 1.8.0
	if( version_compare( get_option( 'genesis_extender_version_number' ), '1.8.0', '<' ) )
	{	
		$genesis_extender_settings = get_option( 'genesis_extender_settings' );
		$new_genesis_extender_settings = array(
			'font_awesome_cdn' => 0,
		...
		update_option( 'genesis_extender_version_number', '1.8.0' );
	}
	
	// Update to Genesis Extender 1.8.1
	if( version_compare( get_option( 'genesis_extender_version_number' ), '1.8.1', '<' ) )
	{	
		update_option( 'genesis_extender_version_number', '1.8.1' );
	}
...
{	
	...
	{
		update_option( 'genesis_extender_version_number', GENEXT_VERSION );
	}
