...
define( 'GENEXT_VERSION', '1.8.1' );
define( 'GENEXT_FONT_AWESOME_VERSION', '4.7.0' );

/**
 * Require files.
 */
require_once( GENEXT_PATH . 'lib/functions/file-paths.php' );
require_once( GENEXT_PATH . 'lib/functions/options.php' );
...
if( is_admin() )
{
	...
	register_activation_hook( GENEXT_PATH . 'lib/update/update.php', 'genesis_extender_activate' );
}
