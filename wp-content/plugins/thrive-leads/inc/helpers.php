...
function tve_leads_get_editor_url( $post_id, $variation_key ) {
	...
	$editor_link = esc_url( add_query_arg( array(
		'tve'    => 'true',
		'_key'   => $variation_key,
		'r'      => uniqid(),
		'action' => 'architect',
...
function tve_leads_process_custom_css( $css ) {
	...
	$css = str_replace( array( ',.thrv_heading', ',.thrv_text_element' ), array( ',.tve-leads-conversion-object .thrv_heading', ',.tve-leads-conversion-object .thrv_text_element' ), $css );
