...
if (!empty($_POST['submit']) && $_POST['submit'] == 'submit') {
    ...
    $css = ' image-style |' . sanitize_text_field($_POST['image-style']) . '|'
            ...
            . ' sb-background-color |rgba(0, 143, 171, 1)|'
                                                ...
                                                <div class="col-sm-6 nopadding">
                                                    <select class="form-control" id="sb-image-item" name="sb-image-item">
                                                        ...
                                                        ?>>6 Items per Row</option>
                                                         <option value="sb-image-hover-responsive-7" <?php
                                                        if ($styledata[3] == 'sb-image-hover-responsive-7') {
                                                            echo 'selected';
                                                        }
                                                        ?>>7 Items per Row</option>
                                                          <option value="sb-image-hover-responsive-8" <?php
                                                        if ($styledata[3] == 'sb-image-hover-responsive-8') {
                                                            echo 'selected';
                                                        }
