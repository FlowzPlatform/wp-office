...
if (!empty($_POST['submit']) && $_POST['submit'] == 'submit') {
    $imagestylename = sanitize_text_field($_POST['image-style']);
    $sbtitle = sanitize_text_field($_POST['sb-image-title']);
    $sbfiles = sanitize_text_field($_POST['sb-image-desc']);
    ...
    $css = ' image-style |' . sanitize_text_field($_POST['image-style']) . '|'
            . ' sb-image-effects |' . sanitize_text_field($_POST['image-effects']) . '|'
            . ' sb-background-color |#00a0ab|'
                                ...
                                <div class="ctu-ulitate-style-3-tabs" id="ctu-ulitate-style-3-id-6">
                                    ...
                                    <div class="oxilab-tabs-content-div-50">
                                        <div class="oxilab-tabs-content-div">
                                            ...
                                            <div class="form-group row form-group-sm">
                                                <label for="sb-image-animation" class="col-sm-6 col-form-label" data-toggle="tooltip" data-placement="top" title="Select Your Image Viewing Animation">Viewing Animation  <span class="ctu-pro-only">Pro Only</span> </label>
                                                <div class="col-sm-6 nopadding">
                                        ...
                                        <div class="oxilab-tabs-content-div">
                                            ...
                                            <div class="form-group row form-group-sm" id="carousel-autoplay-time-show">
                                                <label for="sb-image-box-shadow" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Confirm Your Box Shadow with Color" >Box Shadow <span class="ctu-pro-only">Pro Only</span></label>
                                                <div class="col-sm-6 nopadding">
                                            ...
                                            <div class="form-group row form-group-sm">
                                                ...
                                                <div class="col-sm-6 nopadding">
                                                    <input type="numer" class="form-control sb-image-vendor-color" data-format-orphita="rgb" data-opacity-orphita="true"  id="box-shadow-color" name="box-shadow-color" value="<?php echo $styledata[27]; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="oxilab-tabs-content-div">
                                            ...
                                            <div class="form-group row form-group-sm" id="carousel-autoplay-time-show">
                                                <label for="sb-image-inner-shadow" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Confirm Your Inner Shadow with Color" >Inner Shadow <span class="ctu-pro-only">Pro Only</span></label>
                                                <div class="col-sm-6 nopadding">
                                            ...
                                            <div class="form-group row form-group-sm">
                                                ...
                                                <div class="col-sm-6 nopadding">
                                                    <input type="numer" class="form-control sb-image-vendor-color" data-format-orphita="rgb" data-opacity-orphita="true"  id="inner-shadow-color" name="inner-shadow-color" value="<?php echo $styledata[31]; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="ctu-ulitate-style-3-tabs" id="ctu-ulitate-style-3-id-5">
                                    <div class="oxilab-tabs-content-div-50">
                                        <div class="oxilab-tabs-content-div">
                                            ...
                                            <div class="form-group row form-group-sm">
                                                <label for="sb-image-heading-font-family" class="col-sm-6 col-form-label"  data-toggle="tooltip" data-placement="top" title="Choose Your heading Preferred font, Based on Google Font"> Heading Font Family <span class="ctu-pro-only">Pro Only</span></label>
                                                <div class="col-sm-6 nopadding">
                                    ...
                                    <div class="oxilab-tabs-content-div-50">
                                        <div class="oxilab-tabs-content-div">
                                            ...
                                            <div class="form-group row form-group-sm">
                                                <label for="sb-image-description-font-family" class="col-sm-6 col-form-label"  data-toggle="tooltip" data-placement="top" title="Choose Your Description Preferred font, Based on Google Font"> Description Font Family <span class="ctu-pro-only">Pro Only</span></label>
                                                <div class="col-sm-6 nopadding">
                                        ...
                                        <div class="oxilab-tabs-content-div">
                                            ...
                                            <div class="form-group row form-group-sm">
                                                <label for="sb-image-button-font-family" class="col-sm-6 col-form-label"  data-toggle="tooltip" data-placement="top" title="Choose Your Button Preferred font, Based on Google Font">Button Font Family <span class="ctu-pro-only">Pro Only</span></label>
                                                <div class="col-sm-6 nopadding">
                                ...
                                <div class="ctu-ulitate-style-3-tabs" id="ctu-ulitate-style-3-id-2">
                                    <div class="sb-image-admin-style-settings-div-css">
                                        <div class="form-group">
                                            <label for="sb-image-css">Add Your Custom CSS Code Here <span class="ctu-pro-only">Pro Only</span></label>
                    ...
                    <form method="POST">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label for="ctu-title">Hover Image <span class="ctu-pro-only">Pro Only</span></label>
                                    <div class="col-xs-12-div">
                                        <div class="col-xs-8-div">
                            ...
                            <div class="modal-body">
                                <div class="form-group row form-group-sm">
                                    ...
                                    <div class="col-sm-6 nopadding">
                                        <select class="form-control" name="image-style" id="image-style" size="1">
                                            ...
                                            ?>>Effects 15</option>
                                            <option value="sb-square-effects-16" <?php
                                            if ($imagestyle == 'sb-square-effects-16') {
                                                echo 'selected';
                                            }
                                            ?>>Effects 16 (Pro)</option>
                                            <option value="sb-square-effects-17" <?php
                                            if ($imagestyle == 'sb-square-effects-17') {
                                                echo 'selected';
                                            }
                                            ?>>Effects 17 (Pro)</option>
                                            <option value="sb-square-effects-18" <?php
                                            if ($imagestyle == 'sb-square-effects-18') {
                                                echo 'selected';
                                            }
                                            ?>>Effects 18 (Pro)</option>
                                            <option value="sb-square-effects-19" <?php
                                            if ($imagestyle == 'sb-square-effects-19') {
                                                echo 'selected';
                                            }
                                            ?>>Effects 19 (Pro)</option>
                                            <option value="sb-square-effects-20" <?php
                                            if ($imagestyle == 'sb-square-effects-20') {
                                                echo 'selected';
                                            }
                                            ?>>Effects 20 (Pro)</option>
                                            <option value="sb-square-effects-21" <?php
                                            if ($imagestyle == 'sb-square-effects-21') {
                                                echo 'selected';
                                            }
                                            ?>>Effects 21 (Pro)</option>
                                            <option value="sb-square-effects-22" <?php
                                            if ($imagestyle == 'sb-square-effects-22') {
                                                echo 'selected';
                                            }
                                            ?>>Effects 22 (Pro)</option>
                                            <option value="sb-square-effects-23" <?php
                                            if ($imagestyle == 'sb-square-effects-23') {
                                                echo 'selected';
                                            }
                                            ?>>Effects 23 (Pro)</option>
                                            <option value="sb-square-effects-24" <?php
                                            if ($imagestyle == 'sb-square-effects-24') {
                                                echo 'selected';
                                            }
                                            ?>>Effects 24 (Pro)</option>
                                            <option value="sb-square-effects-25" <?php
                                            if ($imagestyle == 'sb-square-effects-25') {
                                                echo 'selected';
                                            }
                                            ?>>Effects 25 (Pro)</option>
                                            <option value="sb-square-effects-26" <?php
                                            if ($imagestyle == 'sb-square-effects-26') {
                                                echo 'selected';
                                            }
                                            ?>>Effects 26 (Pro)</option>
                                            <option value="sb-square-effects-27" <?php
                                            if ($imagestyle == 'sb-square-effects-27') {
                                                echo 'selected';
                                            }
                                            ?>>Effects 27 (Pro)</option>
                                            <option value="sb-square-effects-28" <?php
                                            if ($imagestyle == 'sb-square-effects-28') {
                                                echo 'selected';
                                            }
                                            ?>>Effects 28 (Pro)</option>
                                            <option value="sb-square-effects-29" <?php
                                            if ($imagestyle == 'sb-square-effects-29') {
                                                echo 'selected';
                                            }
                                            ?>>Effects 29 (Pro)</option>
                                            <option value="sb-square-effects-30" <?php
                                            if ($imagestyle == 'sb-square-effects-30') {
                                                echo 'selected';
                                            }
                                            ?>>Effects 30 (Pro)</option>
                                            <option value="sb-square-effects-31" <?php
                                            if ($imagestyle == 'sb-square-effects-31') {
                                                echo 'selected';
                                            }
                                            ?>>Effects 31 (Pro)</option>
                                            <option value="sb-square-effects-32" <?php
                                            if ($imagestyle == 'sb-square-effects-32') {
                                                echo 'selected';
                                            }
                                            ?>>Effects 32 (Pro)</option>
                                            <option value="sb-square-effects-33" <?php
                                            if ($imagestyle == 'sb-square-effects-33') {
                                                echo 'selected';
                                            }
                                            ?>>Effects 33 (Pro)</option>
                                ...
                                <div class="form-group row form-group-sm">
                                    <label for="sb-background-color" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Customize Your Background Color">Background Color  <span class="ctu-pro-only">Pro Only</span></label>
                                    <div class="col-sm-6 nopadding">
                                ...
                                <div class="form-group row form-group-sm">
                                    <label for="sb-title-color" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Customize Your Title Color">Title Color  <span class="ctu-pro-only">Pro Only</span></label>
                                    <div class="col-sm-6 nopadding">
                                        <input type="text" class="form-control sb-image-vendor-color"  id="titles-color" name="sb-title-color" value="<?php echo $titlecolor; ?>">
                                    </div>
                                </div>
                                <div class="form-group row form-group-sm">
                                    <label for="title-back-color" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Customize Your Title Background">Title Background Color  <span class="ctu-pro-only">Pro Only</span></label>
                                    <div class="col-sm-6 nopadding">
                                ...
                                <div class="form-group row form-group-sm">
                                    <label for="sb-desc-color" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Customize Your Description Color">Description Color  <span class="ctu-pro-only">Pro Only</span></label>
                                    <div class="col-sm-6 nopadding">
                                ...
                                <div class="form-group row form-group-sm">
                                    <label for="sb-button-color" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Customize Your Button Color">Button Color  <span class="ctu-pro-only">Pro Only</span></label>
                                    <div class="col-sm-6 nopadding">
                                ...
                                <div class="form-group row form-group-sm">
                                    <label for="sb-button-background" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Customize Your Button Background Color">Button Background  <span class="ctu-pro-only">Pro Only</span></label>
                                    <div class="col-sm-6 nopadding">
...
<script type="text/javascript">
    ...
    jQuery('#sb-image-add-new-item').on('click', function () {
        ...
        jQuery("#sb-image-effects").val('sb-square-effects-1 sb-left-to-right');
