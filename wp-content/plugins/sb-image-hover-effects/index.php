...
function sb_image_hover_effects_general() {
    ...
    wp_enqueue_script('waypoints', plugins_url('public/waypoints.js', __FILE__));
...
function sb_image_hover_effects_plugin_updater() {
    ...
    $sb_image_hover_effects_updater = new SB_IMAGE_HOVER_EFFECTS_Plugin_Updater(SB_IMAGE_HOVER_EFFECTS_HOME, __FILE__, array(
        'version' => '7.2', // current version number
...
function sb_image_hover_effects_license_page() {
    ...
    <div class="wrap">
        ...
        <p>Select User Role Who Can Save Edit and Delete SB Image Hover Data.</p>
            ...
            <table class="form-table">
                ...
                <tbody>
                    <tr valign="top">
                        ...
                        <td>                           
                            <label class="description" for="sb_image_hover_effects_user_role"><?php _e('Select the Role who can manage SB Image Hover Effects.'); ?>
        ...
        <p>Select Mobile or Touch Device Behaviour for SB Image Hover Data.</p>
        <form method="post" action="options.php">
            <table class="form-table">
...
// retrieve the license from the database
        ...
        <div class="oxilab-admin-notifications">
            ...
            <div class="oxilab-admin-notifications-holder">
                <div class="oxilab-admin-notifications-alert">
                    <p>Thank you for using our SB Image Hover Effects. I Just wanted to see if you have any questions or concerns about my plugins. If you do, Please do not hesitate to <a href="https://wordpress.org/support/plugin/sb-image-hover-effects#new-post">file a bug report</a></p>
                    <p>By the way, did you know we also have a <a href="https://www.oxilab.org/downloads/sb-image-hover-pro/">Premium Version</a>? It offers lots of options with automatic update. It also comes with 16/5 personal support.</p>
                    <p>Thanks Again!</p>
                    <p></p>
                </div>                     
            </div>
    ...
    function sb_image_hover_check_installation_date() {
        ...
        if ($status !== false && $status == 'valid') {
            add_action('admin_notices', 'sb_image_hover_update_admin_notice');
        }
    }

    function sb_image_hover_update_admin_notice() {
        ...
        printf(__('<p>Hey, Thank you for using <strong>SB Image Hover Effects </strong>! There are an Important update for You as our Premium Customer. Kindly Check Into Your <a href=%s><strong>Plugins Menu</strong></a>. If not get kindly wait 3-10 minute and check again hope you will get update notifiction. later any trouble to Update or anythings more kindly Contact via <a href=%s><strong>Oxilab Support</strong></a>.
                     </p>
    ...
    function sb_image_hover_display_admin_notice() {
        ...
        printf(__('<p>Hey, You’ve using <strong>SB Image Hover Effects </strong> for more than 1 week – that’s awesome! Could you please do me a BIG favor and give it a 5-star rating on WordPress? Just to help us spread the word and boost our motivation.!
                     </p>
