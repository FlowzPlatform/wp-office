...
Tags: awesome css3 effects, awesome image effects, CSS Animation, css effects, effects css3, effects hover.
...
[sb_image_oxi id="1"] as basic demo you Also Add shortcode into page and page Builder.

= Does Your plugins Support Visual Composer =

Yes, We also Add extension for Visual Composer. So you can add directly from your visual comporser Page Builder

= Does Your plugins Works on Widgets =

Yes, We Bild an Awesomeplugins where you can add shortcode into your widgets window. Also in SiteOrgin Page Builder.
