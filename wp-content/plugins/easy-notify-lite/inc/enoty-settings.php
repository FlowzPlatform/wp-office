...
global $enplugname, $enshort, $entheopt;
    ...
    <div id="header">
      <div class="logo">
       <div class="icon-option-left"></div>
        <div class="enoty-cp-title"><h2><?php echo $enplugname . "  (v " .ENOTIFY_VERSION. ")"; ?></h2></div>
      </div>
...
<option id="disabled" type="text" value="disabled"/>Disabled</option>
<?php 
...
<option id="<?php echo $post->ID; ?>" type="text" value="<?php echo $post->ID; ?>" <?php if ( enoty_get_option( $enval['id'] ) == $post->ID) { echo 'selected="selected"'; } ?>/><?php echo esc_html( esc_js( the_title(NULL, NULL, FALSE) ) ); ?></option>
<?php endforeach; ?>
</select>
...
<div class="eno_input eno_text <?php if ( isset( $enval['group'] ) ) { echo $enval['group']; } ?>">
	<label for="<?php echo $enval['id']; ?>"><?php echo $enval['name']; ?></label>
 	<input name="<?php echo $enval['id']; ?>" id="<?php echo $enval['id']; ?>" type="<?php echo $enval['type']; ?>" value="<?php if ( enoty_get_option( $enval['id'] ) != "") { echo stripslashes( enoty_get_option( $enval['id'] )  ); } else { echo $enval['std']; } ?>" />
 <small><?php echo $enval['desc']; ?></small><div class="clearfix"></div>
...
<div class="eno_input eno_textarea">
	<label for="<?php echo $enval['id']; ?>"><?php echo $enval['name']; ?></label>
 	<textarea style="vertical-align:top !important;" name="<?php echo $enval['id']; ?>" type="<?php echo $enval['type']; ?>" cols="" rows=""><?php if ( enoty_get_option( $enval['id'] ) != "") { echo stripslashes(enoty_get_option( $enval['id'] ) ); } else { echo $enval['std']; } ?></textarea>
 <small><?php echo $enval['desc']; ?></small><div class="clearfix"></div>
...
<select name="<?php echo $enval['id']; ?>" id="<?php echo $enval['id']; ?>">
<?php foreach ( $enval['options'] as $option ) { ?>
		<option <?php if ( enoty_get_option( $enval['id'] ) == $option) { echo 'selected="selected"'; } ?>><?php echo $option; ?></option><?php } ?>
</select>
...
<div class="eno_input eno_checkbox <?php if ( isset( $enval['group'] ) ) { echo $enval['group']; } ?>">
	<label for="<?php echo $enval['id']; ?>"><?php echo $enval['name']; ?></label>
...
<div class="eno_input">
    ...
    <div id="<?php echo $enval['id']; ?>_slider" ></div><input style="margin-left:10px; width:43px !important;" name="<?php echo $enval['id']; ?>" id="<?php echo $enval['id']; ?>" type="text" value="<?php if ( enoty_get_option( $enval['id'] ) != "") { echo stripslashes( enoty_get_option( $enval['id'] ) ); } else { echo $enval['std']; } ?>" /> <?php echo $enval['pixopr']; ?>
...
<input style="margin-left:3px; width:75px !important;" name="<?php echo $enval['id']; ?>" id="<?php echo $enval['id']; ?>" type="text" value="<?php if ( enoty_get_option( $enval['id'] ) != "") { echo stripslashes( enoty_get_option( $enval['id'] ) ); } else { echo $enval['std']; } ?>" />
...
<div class="eno_input">
    ...
    <input type="hidden" value="<?php if ( enoty_get_option( $enval['id'] ) != "") { echo stripslashes( enoty_get_option( $enval['id'] ) ); } else { echo $enval['std']; } ?>" name="<?php echo $enval['id']; ?>" id="<?php echo $enval['id']; ?>" />
    
    <div class="eno_pattern_box">
    
                	<div style="float: left;" class="eno_pattern_overlay <?php if (!enoty_get_option( $enval['id'] ) || enoty_get_option( $enval['id'] ) == 'none') {echo 'eno_pattern_selected';} ?>" id="eno_no_pattern"> no pattern </div>
...
<div class="eno_options <?php if ( isset( $enval['groupfield'] ) ) { echo $enval['groupfield']; } ?>">
