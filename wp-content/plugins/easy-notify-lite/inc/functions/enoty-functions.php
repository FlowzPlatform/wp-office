  ...
  <div class="tsc_pricingtable03 tsc_pt3_style1" style="margin-bottom:110px; height:700px;">
    <div class="caption_column">
      <ul>
        ...
        <li class="row_style_4"><span>Basic Notify</span><a target="_blank" href="https://ghozylab.com/plugins/easy-notify-pro/demo/demo-basic-notify-and-a-simple-announcement/" style="text-decoration:underline !important;"> Click for Sample</a>&nbsp;&nbsp;<span class="newftr"></span></li>   
                      
        <li class="row_style_2"><span style="font-weight:bold; color:#1064EF">Popup Opt-in ( Subscribe Form )</span><a target="_blank" href="https://ghozylab.com/plugins/easy-notify-pro/demo/popup-opt-in-subscribe-form/" style="text-decoration:underline !important;"> Click for Sample</a>&nbsp;&nbsp;<span class="newftr"></span></li>
        
         <li class="row_style_4"><span style="font-weight:bold; color:#1064EF">Popup with Custom Text & Button</span><a target="_blank" href="https://ghozylab.com/plugins/easy-notify-pro/demo/demo-popup-with-custom-text-button/" style="text-decoration:underline !important;"> Click for Sample</a></li>
        
        <li class="row_style_2"><span style="font-weight:bold; color:#1064EF">Popup with Social Share Buttons</span><a target="_blank" href="https://ghozylab.com/plugins/easy-notify-pro/demo/demo-popup-with-social-share-buttons/" style="text-decoration:underline !important;"> Click for Sample</a></li>
        
        <li class="row_style_3"><span style="font-weight:bold; color:#1064EF">Popup with Video</span><a target="_blank" href="https://ghozylab.com/plugins/easy-notify-pro/demo/demo-popup-with-video/" style="text-decoration:underline !important;"> Click for Sample</a>&nbsp;&nbsp;<span class="newftr"></span></li>
        
        <li class="row_style_2"><span>Integrates with all major email marketing softwares</span><span class="newftr"></span></li>
