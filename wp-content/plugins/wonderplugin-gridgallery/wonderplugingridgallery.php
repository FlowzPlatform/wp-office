...
define('WONDERPLUGIN_GRIDGALLERY_VERSION', '12.7C');
...
define('WONDERPLUGIN_GRIDGALLERY_PLUGIN_VERSION', '12.7');
...
class WonderPlugin_Gridgallery_Plugin {
	...
	function register_menu()
	{
		...
		$menu = add_submenu_page(
				'wonderplugin_gridgallery_overview',
				__('Register', 'wonderplugin_gridgallery'),
				__('Register', 'wonderplugin_gridgallery'),
				'manage_options',
				'wonderplugin_gridgallery_register',
				array($this, 'register' ) );
		add_action( 'admin_print_styles-' . $menu, array($this, 'enqueue_admin_script') );
