...
class WonderPlugin_Gridgallery_View {
	...
	function show_upgrade_to_commercial() {
		...
		<ul class="wonderplugin-feature-list">
			...
			<li><a href="http://www.wonderplugin.com/wordpress-gridgallery/order/" target="_blank">Upgrade to Commercial Version</a></li>
		</ul>
		<?php
	}
				...
				<div class="welcome-panel-column-container">
					...
					<div class="welcome-panel-column welcome-panel-last">
						...
						<ul>
							...
							<li><a href="http://www.wonderplugin.com/wordpress-gridgallery/order/" target="_blank" class="welcome-icon welcome-view-site">Upgrade to Commercial Version</a></li>
							<?php } ?>
						</ul>
					</div>
				</div>
	...
	function print_register() {
		...
		function validateLicenseForm() {
			...
			if ($.trim($("#wonderplugin-gridgallery-key").val()).length <= 0)
			{
		...
		?> <div style="padding-left:10px;padding-top:12px;"> <?php
			if (empty($key)) { ?>
				...
				<tr>
					...
					<td><input name="wonderplugin-gridgallery-key" type="text" id="wonderplugin-gridgallery-key" value="" class="regular-text" /> <input type="submit" name="save-gridgallery-license" id="save-gridgallery-license" class="button button-primary" value="Register"  />
					</td>
				</tr>
				<tr>
					<th></th>
	...
	function print_item()
	{
		...
		<?php
		if (WONDERPLUGIN_GRIDGALLERY_VERSION_TYPE !== "C")
			echo '<div class="updated"><p style="text-align:center;">To remove the Free Version watermark, please <a href="https://www.wonderplugin.com/wordpress-gridgallery/order/" target="_blank">Upgrade to Commercial Version</a>.</p></div>';
