                ...
                <?php if (get_option('social_share') != 0 && ((get_option('facebook_link') == 0) || (get_option('twitter_link') == 0) || (get_option('google_link') == 0) || (get_option('linkedin_link') == 0) || ( get_option('pinterest_link') == 0 ))) { ?>
                    <div class="social-component">
                        ...
                        <?php if (get_option('google_link') == 0): ?>
                            <a data-share="google" data-href="https://plus.google.com/share" data-url="<?php echo get_the_permalink();?>" class="bd-google-share bd-social-share"><i class="fab fa-google-plus-g"></i></a>
                        <?php endif; ?>
            ...
            <div class="spektrum_content_div">
                ...
                <?php if (get_option('social_share') != 0 && ((get_option('facebook_link') == 0) || (get_option('twitter_link') == 0) || (get_option('google_link') == 0) || (get_option('linkedin_link') == 0) || ( get_option('pinterest_link') == 0 ))) { ?>
                    <div class="social-component spektrum-social">
                        ...
                        <?php endif; ?>
                        <?php if (get_option('google_link') == 0): ?>
                            <a href="<?php echo 'https://plus.google.com/share?url=' . get_the_permalink(); ?>" target= _blank class="bd-google-share"><i class="fab fa-google-plus-g"></i></a>
                        <?php endif; ?>
                        <?php if (get_option('linkedin_link') == 0): ?>
    ...
    function wp_blog_designer_menu_function() {
        ...
        <div class="wrap">
            ...
            <div class="updated notice notice-success" id="message">
                ...
                <p><?php echo __('Get access of ','blog-designer') .' <b>' .__('40+ new layouts', '') . '</b> ' . __('and', 'blog-designer') .' <b>' .__('150+ new premium', 'blog-designer') .'</b> ' .__(' features.', 'blog-designer'); ?> <b><a href="<?php echo esc_url('https://codecanyon.net/item/blog-designer-pro-for-wordpress/17069678?ref=solwin'); ?>" target="blank"><?php _e('Upgrade to PRO now', 'blog-designer'); ?></a></b></p>
            </div>
            <?php
                        ...
                        <div id="bdpgeneral" class="postbox postbox-with-fw-options" <?php echo $bdpgeneral_class_show; ?>>
                            <ul class="bd-settings">
                                <li>
                                    ...
                                    <div class="bd-left">
                                        <p class="bd-margin-bottom-50"><?php _e('Select your favorite layout from 6 free layouts.', 'blog-designer'); ?> <b><?php _e('Upgrade for just $39 to access 40+ brand new layouts and other premium features.', 'blog-designer');?></b></p>
                    ...
                    <div class="help-wrapper">
                        <div class="pro-content">
                            <ul class="advertisementContent">
                                <li><?php _e("40+ Beautiful Blog Templates", 'blog-designer'); ?></li>
