...
class GP_Pro_Front {
	...
	public function front_scripts() {
		...
		if ( false !== $manual = apply_filters( 'gppro_force_manual_css_load', false ) ) {
		...
		if ( 'yes' !== $view = Genesis_Palette_Pro::file_access_check( $file['url'] ) ) {
