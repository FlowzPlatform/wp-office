...
$portoColorLib = new PortoColorLib();
...
<?php if ( 1 == $header_type || 4 == $header_type || 9 == $header_type || 13 == $header_type || 14 == $header_type || 17 == $header_type ) : ?>
    @media (min-width: 992px) {
        #header.header-separate .header-main { -webkit-transition: none; -moz-transition: none; transition: none; }
...
<?php endif; ?>
<?php if ( (int)$header_type >= 10 && (int)$header_type <= 17 ) : ?>
    @media (min-width:992px) {
        #header.header-corporate .header-main .container .header-right .searchform-popup { margin-<?php echo $right; ?>: 0; }
    }
    @media (min-width: 768px) {
        ...
        #header.header-corporate .searchform input { height: 34px; border: none; padding: 6px 12px; width: 140px; }
        ...
        #header.header-corporate .searchform .selectric .label { padding-<?php echo $left; ?>: 8px; margin-right: -3px; }
...
<?php if ( 11 == $header_type || 12 == $header_type ) : ?>
    @media (min-width: 992px) {
        ...
        #header.header-12 .header-main.sticky .container .header-right { padding-top: 0; padding-bottom: 0; }
        ...
        #header.header-12 .header-main.change-logo #main-menu .mega-menu > li.menu-item > h5 { padding-top: 33px; padding-bottom: 24px; }
        ...
        #header.header-12 .header-main.change-logo #main-menu .mega-menu > li.menu-item > h5 .tip { top: 15px; }
        ...
        #header.header-12 #main-menu .mega-menu > li.menu-item > h5 { border-radius: 0; padding-top: 38px; padding-bottom: 24px; margin-bottom: 0; }
        ...
        #header.header-12 #main-menu .mega-menu > li.menu-item > h5 .tip { top: 20px; }
...
<?php elseif ( 11 == $header_type ) : ?>
    @media (min-width: 992px) {
        #header.header-11 .header-main.change-logo #main-menu .mega-menu > li.menu-item > a,
        #header.header-11 .header-main.change-logo #main-menu .mega-menu > li.menu-item > h5 { padding-top: 36px; padding-bottom: 20px; }
        #header.header-11 .header-main.change-logo #main-menu .mega-menu > li.menu-item > a .tip,
        #header.header-11 .header-main.change-logo #main-menu .mega-menu > li.menu-item > h5 .tip { top: 18px; }
        ...
        #header.header-11 .header-main.change-logo #main-menu .mega-menu > li.menu-item:hover > h5 { border-width: 0; }
        ...
        #header.header-11 .header-main #main-menu .mega-menu > li.menu-item > h5 { padding-top: 62px; }
        #header.header-11 .header-main #main-menu .mega-menu > li.menu-item > a .tip,
        #header.header-11 .header-main #main-menu .mega-menu > li.menu-item > h5 .tip { top: 44px; }
        ...
        #header.header-11 .header-main #main-menu.show-header-top .mega-menu > li.menu-item:hover > h5 { border-width: 0; }
...
<?php elseif ( 17 == $header_type ) : ?>
    #header.header-17 .main-menu-wrap .menu-right { position: relative; top: auto; padding-<?php echo $left; ?>: 0; -webkit-transform: none; -moz-transform: none; -ms-transform: none; -o-transform: none; transform: none; }
    ...
    @media (min-width: 768px) {
        #header.header-17 .header-main .container > div { padding-top: 0; padding-bottom: 0; }
    }
...
<?php elseif ( 'side' === $header_type ) : ?>
    ...
    @media (min-width: 992px) {
        ...
        .header-wrapper.header-side-nav #header .searchform button { padding: 0 10px; }
        ...
        .header-wrapper.header-side-nav #header .top-links li.menu-item > h5 { margin: 0; padding-top: 5px; padding-bottom: 5px; border-radius: 0; border-top: 1px solid #ccc; border-color: rgba(128, 128, 128, .15) !important; }
        .header-wrapper.header-side-nav #header .top-links li.menu-item:first-child > a,
        .header-wrapper.header-side-nav #header .top-links li.menu-item:first-child > h5 { border-top-width: 0; }
    ...
    .header-side-nav .sidebar-menu > li.menu-item > h5 { margin-left: 0; margin-right: 0; border-color: rgba(128, 128, 128, .18) !important; }
    ...
    @media (max-width: 991px) {
        ...
        .header-wrapper.header-side-nav #header .side-top .view-switcher { float: <?php echo $left; ?>; }
...
/* header type */
@media (min-width: 992px) {
    #header.header-corporate .header-main .container .header-right { padding-<?php echo $left; ?>: <?php echo $b['grid-gutter-width']; ?>px; }
}
...
.sidebar-menu .wide .popup > .inner > ul.sub-menu > li.menu-item { padding-left: <?php echo $b['grid-gutter-width'] / 2; ?>px; padding-right: <?php echo $b['grid-gutter-width'] / 2; ?>px; }
...
.post-item-small { margin: 0 <?php echo $b['grid-gutter-width'] / 2; ?>px; }
...
.vc_row.section.section-with-divider-footer { margin-left: -<?php echo $b['grid-gutter-width'] / 2; ?>px; margin-right: -<?php echo $b['grid-gutter-width'] / 2; ?>px; }
...
@media (min-width: 992px) and <?php echo $screen_large; ?> {
    .col-half-section { max-width: <?php echo (970 / 2) - ($b['grid-gutter-width'] / 2) - 2; ?>px; }
}
@media (max-width: 767px) {
    .col-half-section { max-width: <?php echo 540 - $b['grid-gutter-width']; ?>px; }
}
...
@media (min-width: 768px) {
    ...
    #main.main-boxed .ult-vc-hide-row { max-width: <?php echo 720 + $b['grid-gutter-width']; ?>px; }
    body.boxed .ult-vc-hide-row.section,
    #main.main-boxed .ult-vc-hide-row.section { padding-left: <?php echo $b['grid-gutter-width'] / 2; ?>px; padding-right: <?php echo $b['grid-gutter-width'] / 2; ?>px; }
}
@media (min-width: 992px) {
    body.boxed .ult-vc-hide-row,
    #main.main-boxed .ult-vc-hide-row { max-width: <?php echo 960 + $b['grid-gutter-width']; ?>px; }
}
...
@media <?php echo $screen_large; ?> {
    ...
    #header .header-top .top-links > li.menu-item > h5 { padding-top: 3px !important; padding-bottom: 3px !important; }
    ...
    .mega-menu > li.menu-item > h5 { padding: 9px 9px 8px; }

    .widget_sidebar_menu .widget-title { font-size: 0.8571em; line-height: 13px; padding: 10px 15px; }

    .sidebar-menu > li.menu-item > a,
    .sidebar-menu > li.menu-item > h5 { font-size: 0.9286em; line-height: 17px; padding: 9px 5px; }
...
<?php if ( class_exists( 'Woocommerce' ) ) : ?>
    ...
    ul.pcols-md-6 li.product-category { width: 16.6667%; padding: 0 3px; }
    ...
    ul.pcols-md-5 li.product-category { width: 20%; padding: 0 6px; }
    ...
    ul.pcols-md-4 li.product-category { width: 25%; padding: 0 8px; }
    ...
    ul.pcols-md-3 li.product-category { width: 33.3333%; padding: 0 10px; }
    ...
    ul.pcols-md-2 li.product-category { width: 50%; padding: 0 12px; }
    ...
    .column2 ul.pcols-md-5 li.product-category { width: 20%; padding: 0 2px; }
    ...
    .column2 ul.pcols-md-4 li.product-category { width: 25%; padding: 0 5px; }
    ...
    .column2 ul.pcols-md-3 li.product-category { width: 33.3333%; padding: 0 7px; }
    ...
    .column2 ul.pcols-md-2 li.product-category { width: 50%; padding: 0 10px; }
    .column2 ul.pwidth-md-2 .product-image { font-size: 1.1em; }
    .column2 ul.pwidth-md-2 .add-links { font-size: 1em; }

    ul li.pcols-lg-first,
    .column2 ul li.pcols-lg-first { clear: none; }
    ul li.pcols-md-first,
    .column2 ul li.pcols-md-first { clear: both; }

    ul.list.pcols-md-6 li.product .product-image { width: 17%; font-size: 0.75em; }
    ul.list.pcols-md-6 li.product > *,
    ul.list.pcols-md-6 li.product.show-outimage-q-onimage-alt > div > * { padding-<?php echo $left; ?>: 18.8%; }
    ul.list.pcols-md-5 li.product .product-image { width: 20%; font-size: 0.8em; }
    ul.list.pcols-md-5 li.product > *,
    ul.list.pcols-md-5 li.product.show-outimage-q-onimage-alt > div > * { padding-<?php echo $left; ?>: 21.8%; }
    ...
    ul.list.pcols-md-2 li.product.show-outimage-q-onimage-alt > div > *,
    ul.list.pcols-md-3 li.product > *,
    ul.list.pcols-md-3 li.product.show-outimage-q-onimage-alt > div > *,
    ul.list.pcols-md-4 li.product > *,
    ul.list.pcols-md-4 li.product.show-outimage-q-onimage-alt > div > * { padding-<?php echo $left; ?>: 21.8%; }
    ...
    .column2 ul.list.pcols-lg-5 li.product.show-outimage-q-onimage-alt > div > * { padding-<?php echo $left; ?>: 21.8%; }
    .column2 ul.list.pcols-lg-4 li.product > *,
    .column2 ul.list.pcols-lg-3 li.product > *,
    .column2 ul.list.pcols-lg-2 li.product > *,
    .column2 ul.list.pcols-lg-4 li.product.show-outimage-q-onimage-alt > div > *,
    .column2 ul.list.pcols-lg-3 li.product.show-outimage-q-onimage-alt > div > *,
    .column2 ul.list.pcols-lg-2 li.product.show-outimage-q-onimage-alt > div > * { padding-<?php echo $left; ?>: 24.3%; }
...
@media (min-width: 992px) and <?php echo $screen_large; ?> {
    ...
    #header.search-md .searchform.searchform-cats { width: 160px; }
    #header.search-sm .searchform { width: 288px; }
    #header.search-sm .searchform input { width: 238px; }
    #header.search-sm .searchform.searchform-cats { width: 110px; }
...
<?php if ( class_exists( 'Woocommerce' ) ) : ?>
    @media (max-width: 767px) {
        ...
        .column2 ul.pcols-xs-3 li.product-category { width: 33.3333%; padding: 0 3px; }
        ...
        .column2 ul.pcols-xs-2 li.product-category { width: 50%; padding: 0 6px; }
        ...
        .column2 ul.pcols-xs-1 li.product-category { width: 100%; padding: 0; }
        ...
        .column2 ul.list.pcols-xs-1 li.product > * { padding-<?php echo $left; ?>: 0; }
        ...
        .column2 ul.list.pcols-xs-1 li.product .rating-after { display:none; }
        ...
        ul li.pcols-md-first,
        .column2 ul li.pcols-md-first { clear: none; }
        ul li.pcols-xs-first,
        .column2 ul li.pcols-xs-first { clear: both; }
    }
    @media (max-width: 575px) {
        ul.pcols-ls-2,
        ...
        .column2 ul.pcols-ls-2 li.product-category { width: 50%; padding: 0 3px; }
        ...
        .column2 ul.pcols-ls-1 li.product-category { width: 100%; padding: 0; }
        ...
        ul li.pcols-xs-first,
        .column2 ul li.pcols-xs-first { clear: none; }
        ul li.pcols-ls-first,
        .column2 ul li.pcols-ls-first { clear: both; }
    }
<?php endif; ?>
...
<?php if ($b['border-radius']) : ?>
    ...
    <?php if ( class_exists( 'Woocommerce' ) ) : ?>
        ...
        ul.products li.product-category .links-on-image .add-links-wrap .add-links .quickview { border-radius: 5px !important; }
    <?php endif; ?>
    ...
    <?php if ( class_exists( 'Woocommerce' ) ) : ?>
        ...
        .shop_table.shop_table_responsive.cart-total tbody tr:first-child th { border-radius: 6px 0 0 0; }
        .shop_table.responsive.cart-total tbody tr:last-child th,
        .shop_table.shop_table_responsive.cart-total tbody tr:last-child th { border-radius: 0 0 0 6px; }
    <?php endif; ?>
    ...
    <?php if ( class_exists( 'Woocommerce' ) ) : ?>
        ul.products li.product .links-on-image .add-links-wrap .add-links .quickview,
        ul.products li.product-category .links-on-image .add-links-wrap .add-links .quickview { border-radius: <?php echo $rtl ? "7px 0 7px 0" : "0 7px 0 7px"; ?> !important; }
        ul.products li.product.show-outimage-q-onimage-alt > div,
        ul.products li.product-category.show-outimage-q-onimage-alt > div,
        .product-image,
        ...
        ul.products li.product-category.show-outimage-q-onimage .links-on-image .add-links-wrap .add-links .quickview { border-radius: 0 0 7px 7px !important; }
    <?php endif; ?>
...
<?php if( $b['search-border-radius'] ): ?>
    ...
    ul.products li.product-category.show-outimage-q-onimage-alt .product-image .labels .onhot
    ul.products li.product.show-outimage-q-onimage-alt .product-image .labels .onsale
    ul.products li.product-category.show-outimage-q-onimage-alt .product-image .labels .onsale { border-radius: 20px; }
...
<?php if ($b['thumb-padding']) : ?>
    ...
    <?php if ( class_exists( 'Woocommerce' ) ) : ?>
        ...
        ul.products li.product .links-on-image .add-links-wrap .add-links .quickview,
        ul.products li.product-category .links-on-image .add-links-wrap .add-links .quickview { top: -1px; <?php echo $right; ?>: -1px; }
...
<?php if ( $dark ) : ?>
    ...
    .featured-boxes-style-7 .featured-box .icon-featured:after { box-shadow: 3px 3px $portoColorLib->darken(<?php echo $color_dark; ?>, 3); }
...
<?php if ( class_exists( 'Woocommerce' ) ) : ?>
    <?php if ( $dark ) : ?>
        ...
        .widget ul.product_list_widget li .ajax-loading { background: <?php echo $color_dark_3; ?> url(<?php echo porto_uri; ?>/images/ajax-loader@2x.gif) no-repeat scroll center center / 1.1em 1.1em; }
        ul.products li.product .rating-wrap .rating-before .rating-line,
        ul.products li.product-category .rating-wrap .rating-before .rating-line { background-image:- webkit-linear-gradient(<?php echo $right; ?>, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0.1) 40%, transparent);background-image:linear-gradient(to <?php echo $left; ?>, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0.1) 40%, transparent); }
        ul.products li.product .rating-wrap .rating-after .rating-line,
        ul.products li.product-category .rating-wrap .rating-after .rating-line { background-image:- webkit-linear-gradient(<?php echo $left; ?>, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0.1) 40%, transparent);background-image:linear-gradient(to <?php echo $right; ?>, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0.1) 40%, transparent); }
    ...
    <?php else : ?>
        ...
        .wcml-switcher li.loading,
        ul.product_list_widget li .ajax-loading,
        .widget ul.product_list_widget li .ajax-loading { background: #fff url(<?php echo porto_uri; ?>/images/ajax-loader@2x.gif) no-repeat scroll center center / 1.1em 1.1em; }
        ul.products li.product .rating-wrap .rating-before .rating-line,
        ul.products li.product-category .rating-wrap .rating-before .rating-line { background-image:- webkit-linear-gradient(<?php echo $right; ?>, rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.1) 40%, transparent);background-image:linear-gradient(to <?php echo $left; ?>, rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.1) 40%, transparent); }
        ul.products li.product .rating-wrap .rating-after .rating-line,
        ul.products li.product-category .rating-wrap .rating-after .rating-line { background-image:- webkit-linear-gradient(<?php echo $left; ?>, rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.1) 40%, transparent);background-image:linear-gradient(to <?php echo $right; ?>, rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.1) 40%, transparent); }
    <?php endif; ?>
<?php endif; ?>
...
.mega-menu li.menu-item > h5 > .thumb-info-preview .thumb-info-wrapper,
.sidebar-menu li.menu-item > a > .thumb-info-preview .thumb-info-wrapper,
.sidebar-menu li.menu-item > h5 > .thumb-info-preview .thumb-info-wrapper { background: <?php echo if_dark( $color_dark_4, '#fff' ); ?>; }
.mega-menu .wide .popup > .inner,
.sidebar-menu .wide .popup > .inner { background: <?php echo if_dark( $color_dark_3, '#fff' ); ?>; }
.mega-menu .wide .popup > .inner > ul.sub-menu > li.menu-item > a,
.mega-menu .wide .popup > .inner > ul.sub-menu > li.menu-item > h5,
.sidebar-menu .wide .popup > .inner > ul.sub-menu > li.menu-item > a,
.sidebar-menu .wide .popup > .inner > ul.sub-menu > li.menu-item > h5 { color: <?php echo if_dark( '#fff', '#333' ); ?>; }
.mega-menu .wide .popup > .inner > ul.sub-menu > li.menu-item li.menu-item > a:hover,
.mega-menu .wide .popup > .inner > ul.sub-menu > li.menu-item li.menu-item > h5:hover { background: <?php echo if_dark( $portoColorLib->lighten($color_dark_3, 5), '#f4f4f4' ); ?>; }
.mobile-sidebar,
...
section.section,
.vc_row.section,
.vc_column_container.section { background-color: <?php echo if_light( '#f4f4f4', $color_dark_2 ); ?>; border-top: 5px solid <?php echo if_light( '#f1f1f1', $color_dark_3 ); ?>; }
...
.tabs-left .nav-tabs > li .nav-link { border-right: 1px solid <?php echo if_light( '#eee', $color_dark_3 ); ?>; border-left: 3px solid <?php echo if_light( '#eee', $color_dark_3 ); ?>; }
.tabs-left .nav-tabs > li.active .nav-link,
.tabs-left .nav-tabs > li.active .nav-link:hover,
.tabs-left .nav-tabs > li.active .nav-link:focus { border-right-color: <?php echo if_light( '#fff', $color_dark_4 ); ?>; }
.tabs-right .nav-tabs > li .nav-link { border-right: 3px solid <?php echo if_light( '#eee', $color_dark_3 ); ?>; border-left: 1px solid <?php echo if_light( '#eee', $color_dark_3 ); ?>; }
.tabs-right .nav-tabs > li.active .nav-link,
.tabs-right .nav-tabs > li.active .nav-link:hover,
.tabs-right .nav-tabs > li.active .nav-link:focus { border-left-color: <?php echo if_light( '#fff', $color_dark_4 ); ?>; }
...
.sidebar-content .widget.widget_wysija { background: <?php echo if_light( '#f4f4f4', $color_dark_4 ); ?>; }
...
<?php if ( class_exists( 'Woocommerce' ) ) : ?>
    ...
    #reviews .commentlist li .comment-text:before { border-right: 15px solid <?php echo if_light( '#f5f7f7', $color_dark_3 ); ?>; }
    div.quantity .minus,
    ...
    .product-thumbs-slider.owl-carousel .img-thumbnail { border: 1px solid <?php echo $dark ? $color_dark_3 : "#ddd"; ?>; }
<?php endif; ?>
...
.vc_column_container.section.section-text-dark p { color: <?php echo $portoColorLib->lighten($color_dark, 10); ?>; }
...
.widget_layered_nav .widget-title,
.widget_layered_nav_filters .widget-title,
.widget_rating_filter .widget-title { background: <?php echo $widget_title_bg_color; ?>; border-bottom-color: <?php echo $widget_border_color; ?>; }
