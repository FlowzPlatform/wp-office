...
<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/mystyle.css" type="text/css" media="screen" />
    <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/mystyle2.css" type="text/css" media="screen" />
    <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/mystyle3.css" type="text/css" media="screen" />
    <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/mystyle4.css" type="text/css" media="screen" />
    <!-- 	<link rel="stylesheet" href="<?php //bloginfo('template_url'); ?>/css/mystyle5.css" type="text/css" media="screen" />
    <link rel="stylesheet" href="<?php //bloginfo('template_url'); ?>/css/mystyle6.css" type="text/css" media="screen" /> -->
    <!-- <link rel="stylesheet" href="<?php //bloginfo('template_url'); ?>/css/mystyle7.css" type="text/css" media="screen" /> -->
    <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/mystyle8.css" type="text/css" media="screen" />
...
<body <?php body_class(array($body_class)); ?><?php echo $showing_overlay ? 'data-loading-overlay' : '' ?>>
    ...
    <div class="page-wrapper<?php if ($header_type == 'side') echo ' side-nav' ?><?php if (isset($porto_settings['header-side-position']) && $porto_settings['header-side-position'] ) echo ' side-nav-right' ?>"><!-- page wrapper -->
        ...
        <div id="main" class="<?php if ($porto_layout == 'wide-left-sidebar' || $porto_layout == 'wide-right-sidebar' || $porto_layout == 'left-sidebar' || $porto_layout == 'right-sidebar') echo 'column2' . ' column2-' . str_replace('wide-', '', $porto_layout); else echo 'column1'; ?><?php if ($porto_layout == 'widewidth' || $porto_layout == 'wide-left-sidebar' || $porto_layout == 'wide-right-sidebar') echo ' wide clearfix'; else echo ' boxed' ?><?php if (!$breadcrumbs && !$page_title) echo ' no-breadcrumbs' ?><?php if (porto_get_wrapper_type() != 'boxed' && $porto_settings['main-wrapper'] == 'boxed') echo ' main-boxed' ?>"><!-- main -->
            ...
            <?php do_action('porto_before_content'); ?>
