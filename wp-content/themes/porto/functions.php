...
function porto_css() {
    ...
    if ( defined( 'WPB_VC_VERSION' ) && isset( $porto_settings['speed-optimize-js-composer'] ) && !$porto_settings['speed-optimize-js-composer'] ) {

        wp_deregister_style( 'js_composer_front' );

        wp_dequeue_style( 'js_composer_front' );

        wp_register_style( 'js_composer_front', vc_asset_url( 'css/js_composer.css' ), array(), WPB_VC_VERSION );
    ...
    include_once porto_dir . '/style.php';
    ...
    wp_register_style( 'porto-dynamic-style', false );

    wp_add_inline_style( 'porto-dynamic-style', $css );
    ...
    $fonts = array( 'body', 'alt', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'menu', 'menu-side', 'menu-popup', 'add-to-cart', 'custom1', 'custom2', 'custom3' );
...
function porto_admin_css() {
    ...
    if ($pagenow == 'admin.php' && isset($_GET['page']) && 'porto-demos' === $_GET['page']) {

        wp_enqueue_style('porto_magnific_popup', porto_css.'/magnific-popup.min.css', false, porto_version, 'all');
...
function porto_admin_scripts() {
    ...
    if ($pagenow == 'admin.php' && isset($_GET['page']) && 'porto-demos' === $_GET['page']) {
        ...
        wp_register_script('porto-magnific-popup', porto_js.'/jquery.magnific-popup.min.js', array('jquery'), porto_version, true);

        wp_enqueue_script('porto-magnific-popup');
