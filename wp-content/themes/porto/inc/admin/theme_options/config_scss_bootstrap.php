...
$grid-breakpoints: (
  ...
  md: 768px,
  lg: 992px,
  xl: <?php echo $b['container-width'] + $b['grid-gutter-width'] ?>px
) !default;
...
$container-max-widths: (
  ...
  md: 720px,
  lg: 960px,
  xl: <?php echo $b['container-width'] ?>px
) !default;
...
<?php if ($b['thumb-padding']) : ?>
	...
	$thumbnail-border-color:            <?php echo $dark ? '$color-dark-3' : '#ddd' ?> !default;
<?php else : ?>
