                ...
                <form method="post" class="woocommerce-ResetPassword lost_reset_password">
                    ...
                    <?php if (version_compare($porto_woo_version, '2.6', '>=')) : ?>
                        ...
                        <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                            <label for="user_login"><?php _e( 'Username or email', 'porto' ); ?></label>
                        ...
                        <p class="woocommerce-form-row form-row clearfix">
                            ...
                            <input type="submit" class="woocommerce-Button button btn-lg pt-right" value="<?php esc_attr_e( 'Reset Password', 'porto' ); ?>" />
                        </p>
                    ...
                    <?php else : ?>
                        <?php if( 'lost_password' === $args['form'] ) : ?>
                            ...
                            <p class="form-row form-row-wide"><label for="user_login"><?php _e( 'Username or email', 'porto' ); ?></label> <input class="input-text" type="text" name="user_login" id="user_login" /></p>
