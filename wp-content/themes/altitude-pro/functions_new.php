...
function altitude_enqueue_scripts_styles() {
	...
	wp_enqueue_style( 'altitude-google-fonts', '//fonts.googleapis.com/css?family=Raleway:300,400,500,600,700,800,900', array(), CHILD_THEME_VERSION );
...
genesis_register_sidebar( array(
	'id'          => 'front-page-8',
	'name'        => __( 'Front Page 8', 'altitude-pro' ),
	'description' => __( 'This is the front page 8 section.', 'altitude-pro' ),
) );
genesis_register_sidebar( array(
	'id'          => 'front-page-6',
